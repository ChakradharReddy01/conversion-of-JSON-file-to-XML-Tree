...
# with open('D:/New_Securin/sampletry2/complete_assign_scratchToEnd/finalcode/finalxml.xml','w') as f:
#     f.write(pretty_xml_str)
with open(b+'/finalxml.xml','w') as f:
    f.write(pretty_xml_str)
